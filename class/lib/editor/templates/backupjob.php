 ...
 * @file    : backupjob.php $
 * 
 * @id      : backupjob.php | Wed Sep 16 11:33:37 2015 +0200 | Eugen Mihailescu <eugenmihailescux@gmail.com> $
*/
...
onchange="js55f93aab8f090.toggle_backup_name(this);"
...
<tr>
<td><label for="wrkdir"><?php _pesc('Working directory');?></label></td>
<td><input type="text" name="wrkdir" id="wrkdir"
value=<?php echo '"' . $this->settings['wrkdir'] . '"'; ?> size="30"><a
...
onchange="js55f93aab8f090.toggle_compression_type(this);">
...
onchange="js55f93aab8f090.submitOptions(this,0);" style='width: 100%'>
<?php echo $clo_str;?>
</select></td>
</tr>
</table></td>
...
onclick="js55f93aab8f090.submitOptions(this,0);"><label for="toolchain_int"><?php echo WPMYBACKUP; ?></label></td>
...
printf ( '<img src="%s" title="%s">', $this->getImgURL ( 'unchecked.png' ), sprintf ( _esc ( 'External toolchain doesn`t seem to work on local %s' ), PHP_OS ) );
?>
</td>
</tr>
</table>
...
?></td>
<?php
if (defined ( 'JOB_BENCHMARK' ) && $os_tool_ok) {
...
<?php
if (defined ( 'OPER_COMPRESS_EXTERN' ) && 'extern' == $compression_tool) {
?>
<tr>
...
id="comp_cmd_hint"
onmouseover="js55f93aab8f090.showClipboardBtn(this,'visible','comp_cmd_clpb');"
onmouseout="js55f93aab8f090.showClipboardBtn(this,'hidden','comp_cmd_clpb');">
...
onclick="js55f93aab8f090.popupPrompt('<?php _pesc('Compatibility-mode copy');?>','<?php _pesc('Copy to clipboard: Ctrl+C, ESC (will strip the HTML tags :-)');?>', null,{'<?php _pesc('Close (ESC)');?>':null},js55f93aab8f090.stripHelpLink('comp_cmd_hint'),'textarea');"
...
value=<?php echo '"' . $this->settings['size'] . '"'; ?> size=5> MiB<a
class='help' onclick=<?php
echoHelp ( $help_4 );
?>>[?]</a></td>
</tr>
...
id="btn_run_backup"
onclick=<?php echo '"js55f93aab8f090.asyncRunBackup(\'run_backup\',\''._esc('Backup').'\',\''.wp_create_nonce_wrapper('run_backup').'\',\''.wp_create_nonce_wrapper('get_progress').'\',\''.wp_create_nonce_wrapper('cleanup_progress').'\',\''.wp_create_nonce_wrapper('abort_job').'\');" ';?>
