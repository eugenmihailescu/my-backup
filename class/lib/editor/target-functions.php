 ...
 * 
 * @id      : target-functions.php | Mon Sep 14 21:14:57 2015 +0200 | Eugen Mihailescu <eugenmihailescux@gmail.com> $
*/
...
echo sprintf ( $err_msg, sprintf ( _esc ( "is not yet defined as expected (ie named <b>%s</b>)" ), $target_editor_class ) );
return;
}
