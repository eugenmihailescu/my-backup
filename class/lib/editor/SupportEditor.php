 ...
 * 
 * @id      : SupportEditor.php | Wed Sep 16 11:33:37 2015 +0200 | Eugen Mihailescu <eugenmihailescux@gmail.com> $
*/
...
if (! $this->_is_activated)
return;
$help_debug_on = "'" . _esc ( 'This option activates a mechanism by which when an error occurs (no matter if it`s an program error or just an exception, like I/O error, HTTP timeout, etc) its trace is automatically captured and saved into a special trace log file. <a class=\\\'help\\\' href=\\\'#\\\' onclick=\\\'js55f93aab8f090.print_debug_sample(&quot;debug&quot;);\\\'>' . _esc ( 'See example' ) . '</a>.' );
...
$help_stats_debug_on = "'" . _esc ( 'This option will dump to a log file the JavaScript code that represents the datase sent to Google Charts API in order to get back a user-friendly chart.' ) . '<br><a class=\\\'help\\\' href=\\\'#\\\' onclick=\\\'js55f93aab8f090.print_debug_sample(&quot;stats&quot;);\\\'>' . _esc ( 'See example' ) . ".</a>'";
