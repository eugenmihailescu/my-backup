 ...
 * @file    : NonceLib.php $
 * 
 * @id      : NonceLib.php | Mon Sep 14 21:14:57 2015 +0200 | Eugen Mihailescu <eugenmihailescux@gmail.com> $
*/

namespace MyNixWorld;

define ( 'WPMYBAK_NONCE_UNIQUE_KEY', 'isGzXX8m9u0OtrwxL+meLep9dTHAfgbMelm1DXvPXu4=' ); 
define ( 'WPMYBAK_NONCE_LIFESPAN', 3600 ); 
class NonceLib {
private $_user_id;
private $_nonce_file;
...
$this->_nonce_file = empty ( $nonce_file ) ? sys_get_temp_dir () . DIRECTORY_SEPARATOR . get_class ( $this ) . '-nonces.log' : $nonce_file;
