 ...
 * 
 * @id      : CurlErrorMessages.php | Fri Mar 18 10:06:27 2016 +0100 | eugenmihailescu <eugenmihailescux@gmail.com> $
*/
...
CURLE_NO_CONNECTION_AVAILABLE => '(For internal use only, will never be returned by libcurl) No connection available, the session will be queued. (added in 7.30.0)',
