 ...
 * 
 * @id      : CurlErrorCodes.php | Tue Feb 16 15:27:30 2016 +0100 | Eugen Mihailescu <eugenmihailescux@gmail.com> $
*/

namespace MyBackup;

defined ( __NAMESPACE__.'\\CURLSHE_OK' ) || define ( __NAMESPACE__.'\\CURLSHE_OK', 0 );
defined ( __NAMESPACE__.'\\CURLSHE_BAD_OPTION' ) || define ( __NAMESPACE__.'\\CURLSHE_BAD_OPTION', 1 );
defined ( __NAMESPACE__.'\\CURLSHE_IN_USE' ) || define ( __NAMESPACE__.'\\CURLSHE_IN_USE', 2 );
defined ( __NAMESPACE__.'\\CURLSHE_INVALID' ) || define ( __NAMESPACE__.'\\CURLSHE_INVALID', 3 );
defined ( __NAMESPACE__.'\\CURLSHE_NOMEM' ) || define ( __NAMESPACE__.'\\CURLSHE_NOMEM', 4 );
defined ( __NAMESPACE__.'\\CURLSHE_NOT_BUILT_IN' ) || define ( __NAMESPACE__.'\\CURLSHE_NOT_BUILT_IN', 5 );
defined ( __NAMESPACE__.'\\CURLM_UNKNOWN_OPTION' ) || define ( __NAMESPACE__.'\\CURLM_UNKNOWN_OPTION', 6 );
defined ( __NAMESPACE__.'\\CURLM_ADDED_ALREADY' ) || define ( __NAMESPACE__.'\\CURLM_ADDED_ALREADY', 7 );
