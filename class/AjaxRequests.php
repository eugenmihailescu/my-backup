 ...
 * 
 * @id      : AjaxRequests.php | Tue Feb 16 15:27:30 2016 +0100 | Eugen Mihailescu <eugenmihailescux@gmail.com> $
*/
...
file_exists( ADDONFUNC_PATH . $callback . '.php' ) && $this->_action_handler->anonymousExec( $callback );
}
}
