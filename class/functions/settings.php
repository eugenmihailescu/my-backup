 ...
 * @file    : settings.php $
 * 
 * @id      : settings.php | Mon Dec 28 17:57:55 2015 +0100 | Eugen Mihailescu <eugenmihailescux@gmail.com> $
*/
...
'";if(params.length>0)parent.asyncRunJob(parent.ajaxurl, params, null, null, null, 3, "__dummy__", -1, null);});'; 
...
wp_create_nonce_wrapper( 'abort_job' ) . '", null, null, null, 3, "__dummy__", -1, null);}});';
...
foreach ( array( 'nonce', 'action' ) as $garbage )
...
$fixPathBackslashes( array( 'wrkdir', 'cygwin', 'excludedirs', 'logdir' ) );
$resetProperties( array( 'run_backup', 'compression_benchmark' ) );
