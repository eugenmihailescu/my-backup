 ...
 * @file    : url.php $
 * 
 * @id      : url.php | Mon Sep 14 21:14:57 2015 +0200 | Eugen Mihailescu <eugenmihailescux@gmail.com> $
*/
...
if (headers_sent ())
die ( _esc ( 'Cannot redirect to the download file. Headers already sent.' ) );
header ( 'Expires: 0' );
