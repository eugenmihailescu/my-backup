 ...
 * 
 * @id      : wp-schedule.php | Tue Dec 13 06:40:49 2016 +0100 | eugenmihailescu <eugenmihailescux@gmail.com> $
*/
...
sprintf( _esc( "[%s] %s Cron schedule %s" ) , date( DATETIME_FORMAT ), WPMYBACKUP, strip_tags($opstr) ) );
