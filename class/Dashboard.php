 ...
 * @file    : Dashboard.php $
 * 
 * @id      : Dashboard.php | Tue Feb 7 08:55:11 2017 +0100 | eugenmihailescu <eugenmihailescux@gmail.com> $
*/
...
if (is_array($ssl_info) && isset($ssl_info['certificate']) && isset($ssl_info['certificate']['status']) && strpos($ssl_info['certificate']['status'], '18')) {
...
sprintf(_esc('The Wordpress version looks/works exactly like this one, except the <i>%s</i> and <i>%s</i> tabs which are adapted to Wordpress. %s.'), getTabTitleById(SRCFILE_SOURCE), getTabTitleById(APP_SCHEDULE), readMoreHere(selfURL(true) . 'screenshot'))
);
