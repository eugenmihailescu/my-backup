 ...
 * @file    : constants.php $
 * 
 * @id      : constants.php | Tue Dec 13 06:40:49 2016 +0100 | eugenmihailescu <eugenmihailescux@gmail.com> $
*/
...
defined(__NAMESPACE__.'\\PCLZIP') && $COMPRESSION_FILTERS[PCLZIP] = array(
'zip',
'w'
);
...
defined(__NAMESPACE__.'\\PCLZIP') && $COMPRESSION_HEADERS[PCLZIP] = array(
4,
'(PK(\x03|\x05|\x07)(\x04|\x06|\x08))'
);
...
$COMPRESSION_LEVEL_SUPPORT = array(
NONE => false,
GZ => true,
BZ2 => true
);
...
define(__NAMESPACE__."\\RESTORE_DEBUG_LOG", LOG_PREFIX . "-restore-debug.log"); 
...
('\\' == DIRECTORY_SEPARATOR) && $dir = str_replace(array(
