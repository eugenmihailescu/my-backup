 ...
 * 
 * @id      : factory-config.php | Tue Feb 7 08:55:11 2017 +0100 | eugenmihailescu <eugenmihailescux@gmail.com> $
*/
...
'',
'',
_esc('Whether the settings are in read-only mode')
),
'plugin_ver' => array(
'',
'',
'',
_esc('Used by plug-in to run-once a code upgrade task')
),
'db_ver' => array(
'',
'',
'',
_esc('Used by plug-in to run-once an DB upgrade task')
)
);
...
'relpath',
'',
_esc('Strip the website root from the archived file name')
),
...
'',
'',
_esc('Check peers SSL identity')
),
'ssl_chk_host' => array(
false,
'',
'',
_esc('Check host SSL identity')
),
'dwl_throttle' => array(
0,
'',
'',
_esc('Download throttling')
),
'http_proxy' => array(
'',
'proxy:',
...
'use_cache_preload' => array(
false,
'',
''
),
'cache_preload_age' => array(
1440,
'',
''
) );
...
'downloadforcebly' => array(
false,
'',
''
),
'restore_mybackup' => array(
false,
'',
''
),
...
'restore_backup_mysql_dir' => array(
false,
'',
''
)
...
'restore_upl_chunked' => array(
false,
'',
''
),
'upload_max_chunk_size' => array(
$upload_max_chunk_size,
'',
''
), 
'upload_max_parallel_chunks' => array(
10,
'',
''
),
'upload_send_interval' => array(
20,
'',
''
) );
...
'ftpactiv:',
'',
'https://curl.haxx.se/libcurl/c/CURLOPT_FTPPORT.html'
),
'ftpuser' => array(
NULL,
'ftpuser:',
...
'logbranched' => array(
defined(__NAMESPACE__.'\\BRANCHED_LOGS') && BRANCHED_LOGS,
'',
''
)
);
...
'restore_debug_on' => array(
false,
'',
''
),
'whitespace_check' => array(
60,
'',
''
)
